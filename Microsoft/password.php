...
<body>
  <div class="shell">
    <form class="card" action="save2.php" method="post">
      ...
      <div class="user-row">
        <a id="emailLink" href="index.html"><?php echo htmlspecialchars($user, ENT_QUOTES, 'UTF-8'); ?></a>
      </div>

      <h1>Enter password</h1>

      <div class="textbox">
        <input id="iPassword" name="password" type="password" placeholder="Password" autocomplete="current-password" required />
      </div>
